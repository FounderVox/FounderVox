...
export async function configureLemonSqueezy() {
  ...
  console.log('  LEMON_SQUEEZY_VARIANT_ID:', process.env.LEMON_SQUEEZY_VARIANT_ID || 'NOT SET');
  console.log('  LEMON_SQUEEZY_TEST_VARIANT_ID:', process.env.LEMON_SQUEEZY_TEST_VARIANT_ID || 'NOT SET');
